      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-accent/20 bg-gradient-to-br from-accent/[0.08] via-white/[0.02] to-transparent p-10 text-center sm:p-14">
          ...
          <h2 className="font-display text-3xl font-semibold tracking-tight text-white sm:text-4xl">
            Ready to start with simulated capital?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-muted">
            Pick an account size, complete a secure Stripe checkout, and trade
            within clear, published rules.
          </p>
          <div className="mx-auto mt-8 flex max-w-md flex-col gap-3 sm:flex-row">
            <div className="flex-1">
              <CheckoutButton planId="50k" label="Start with 50K" />
            </div>
            <a
              href="#accounts"
          ...
          <p className="mt-5 text-xs text-faint">
            Payouts are not guaranteed. Trading involves risk.
          </p>
        </div>
      </div>
    </section>
